...
bias = (weight_speed*pow(calculate_speed(),2))-(weight_distance*calculate_distance())

def decision_factor():
	distance_to_obstacle = calculate_distance()
	decision_factor = (weight_speed*pow(calculate_speed(),2))/((weight_distance*distance_to_obstacle)+bias)
